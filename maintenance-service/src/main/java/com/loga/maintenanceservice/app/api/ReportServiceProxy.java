...
public interface ReportServiceProxy {
    ...
    public void produceReportByDate(HttpServletResponse response, @PathVariable("src") String src,
    ...
    public void produceReportBetweenDate(HttpServletResponse response, @PathVariable("src") String src,
